...
-- NOTE: Originally 038_team, lost during migration collision fix (see lessons.md).
...
CREATE TABLE team (
    ...
    queue_policy JSONB DEFAULT '{"strategy":"round_robin","max_queue":100}',
    capability_tags TEXT[] DEFAULT '{}',
    max_run_duration INTERVAL DEFAULT '2 hours',
