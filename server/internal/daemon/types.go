...
type Task struct {
	...
	SharedContext    *protocol.SharedContext `json:"shared_context,omitempty"`    // collaborative context for multi-agent awareness
}
...
type AgentData struct {
	...
	Role         string      `json:"role,omitempty"` // "executor" (default), "coordinator", "reviewer"
